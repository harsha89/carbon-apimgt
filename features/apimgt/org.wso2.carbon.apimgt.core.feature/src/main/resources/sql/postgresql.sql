...
CREATE SEQUENCE AM_ENDPOINTS_SEQ START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS AM_ENDPOINT (
    ID INTEGER DEFAULT NEXTVAL('AM_ENDPOINTS_SEQ'),
    ...
    VISIBLE_ROLES VARCHAR(512) DEFAULT NULL,
